...
function xr(e, t, n, r, l) {
  ...
  if (((i = 0), (r = r === "" ? "." : r + ":"), Gi(e)))
    ...
    for (e = s.call(e), u = 0; !(o = e.next()).done; )
      (o = o.value), (s = r + zl(o, u++)), (i += xr(o, t, n, s, l));
  else if (o === "object")
    throw (
      ((t = String(e)),
      Error(
 ...
 */ (function (e) {
  ...
  function r(x) {
    ...
    if (T !== R) {
      x[0] = T;
      e: for (var Q = 0, Z = x.length, lr = Z >>> 1; Q < lr; ) {
        var gt = 2 * (Q + 1) - 1,
          Nl = x[gt],
          wt = gt + 1,
          or = x[wt];
        if (0 > l(Nl, T))
          wt < Z && 0 > l(or, Nl)
            ? ((x[Q] = or), (x[wt] = T), (Q = wt))
            : ((x[Q] = Nl), (x[gt] = T), (Q = gt));
        else if (wt < Z && 0 > l(or, T)) (x[Q] = or), (x[wt] = T), (Q = wt);
        else break e;
      }
    }
    return R;
  ...
  function k(x, R) {
    ...
    try {
      ...
      if (m !== null) var lr = !0;
        ...
        var gt = n(c);
        gt !== null && Pl(v, gt.startTime - R), (lr = !1);
      }
      return lr;
    } finally {
      (m = null), (p = T), (S = !1);
...
function en(e, t) {
  for (In[e] = t, e = 0; e < t.length; e++) _s.add(t[e]);
}
var Ke = !(
    typeof window > "u" ||
...
function lu(e) {
  if ((e = tr(e))) {
    ...
    var t = e.stateNode;
    t && ((t = fl(t)), mo(e.stateNode, e.type, t));
  }
}
function Ds(e) {
...
function vf(e, t, n, r, l, o, i, u, s) {
  (Nn = !1), (Fr = null), hf.apply(mf, arguments);
}
function yf(e, t, n, r, l, o, i, u, s) {
  if ((vf.apply(this, arguments), Nn)) {
    if (Nn) {
      var c = Fr;
      (Nn = !1), (Fr = null);
...
function _r(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = tr(n)), t !== null && fi(t), (e.blockedOn = n), !1;
    t.shift();
  }
  return !0;
}
...
function di(e, t, n, r) {
  if (Br) {
    var l = So(e, t, n, r);
    if (l === null) Wl(e, t, r, Ar, n), uu(e, r);
...
var Ar = null;
function So(e, t, n, r) {
  if (((Ar = null), (e = si(r)), (e = Et(e)), e !== null))
  ...
  sl = V({}, er, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== yn &&
            (yn && e.type === "mousemove"
              ? ((Ml = e.screenX - yn.screenX), (Il = e.screenY - yn.screenY))
              : (Il = Ml = 0),
            (yn = e)),
          Ml);
    },
...
var ld = Ke && "TextEvent" in window && !zn,
  ra = Ke && (!vi || (zn && 8 < zn && 11 >= zn)),
...
function yu() {
  Ln && (Ln.detachEvent("onpropertychange", sa), (An = Ln = null));
}
function sa(e) {
  if (e.propertyName === "value" && al(An)) {
    var t = [];
    ia(t, An, e, si(e)), As(sd, t);
  }
}
function cd(e, t, n) {
  e === "focusin"
    ? (yu(), (Ln = t), (An = n), Ln.attachEvent("onpropertychange", sa))
    : e === "focusout" && yu();
}
function fd(e) {
...
function Vn(e, t) {
  ...
  for (r = 0; r < n.length; r++) {
    var l = n[r];
    if (!to.call(t, l) || !Ie(e[l], t[l])) return !1;
  }
  return !0;
}
function gu(e) {
...
for (var Bl = 0; Bl < ku.length; Bl++) {
  var Al = ku[Bl],
    yd = Al.toLowerCase(),
    gd = Al[0].toUpperCase() + Al.slice(1);
  mt(yd, "on" + gd);
}
  ...
  if (!e[mr]) {
    (e[mr] = !0),
      _s.forEach(function (n) {
        n !== "selectionchange" && (wd.has(n) || Vl(n, !1, e), Vl(n, !0, e));
      });
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = Dn(a, f)), v != null && y.push(Hn(a, v, d)))),
            z)
          )
            break;
          a = a.return;
      ...
      N &&
        (ra &&
          ...
          (Dt || N !== "onCompositionStart"
            ? N === "onCompositionEnd" && Dt && (P = na())
            : ((nt = h),
              (pi = "value" in nt ? nt.value : nt.textContent),
              (Dt = !0))),
        (_ = Vr(c, N)),
        0 < _.length &&
          ((N = new fu(N, e, null, n, h)),
          m.push({ event: N, listeners: _ }),
          P ? (N.data = P) : ((P = oa(n)), P !== null && (N.data = P)))),
        (P = ld ? od(e, n) : id(e, n)) &&
...
function U(e) {
  0 > At || ((e.current = zo[At]), (zo[At] = null), At--);
}
function F(e, t) {
  At++, (zo[At] = e.current), (e.current = t);
}
var ht = {},
  oe = vt(ht),
  de = vt(!1),
...
function za(e) {
  ...
  function w(f, a, d, v) {
    for (
      var k = null, _ = null, P = a, N = (a = 0), H = null;
      P !== null && N < d.length;
      N++
    ) {
  ...
  function y(f, a, d, v) {
    ...
    for (
      var _ = (k = null), P = a, N = (a = 0), H = null, O = d.next();
      P !== null && !O.done;
      N++, O = d.next()
    ) {
      P.index > N ? ((H = P), (P = null)) : (H = P.sibling);
      var ze = p(f, P, O.value, v);
      if (ze === null) {
        P === null && (P = H);
        break;
      }
...
function Pi(e, t) {
  switch ((F(Yn, t), F(Kn, e), F(Be, nr), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function Ri(e, t, n, r, l, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Lr.current = e === null || e.memoizedState === null ? Od : Md),
    (e = n(r, l)),
    Tn)
  ) {
    o = 0;
...
function ja(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    ji(Ia.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || o || (J !== null && J.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      Zn(9, Ma.bind(null, n, r, l, t), void 0, null),
      q === null)
    )
      throw Error(g(349));
    Lt & 30 || Oa(n, t, l);
...
function Va(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), hl(4, 4, Aa.bind(null, t, e), n)
  );
}
function Oi() {}
function Wa(e, t) {
...
function Qa(e, t, n) {
  return Lt & 21
    ? (Ie(n, t) || ((n = Xs()), (A.lanes |= n), (Rt |= n), (e.baseState = !0)),
      t)
  ...
  Od = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Rr(4194308, 4, Aa.bind(null, t, e), n)
      );
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (l.queue = o),
        Du(Ia.bind(null, r, o, e), [e]),
        (r.flags |= 2048),
        Zn(9, Ma.bind(null, r, o, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function Wu(e, t, n, r, l) {
  ...
  if ((Jt(t, l), t.stateNode === null))
    Tr(e, t), Na(t, n, r), Oo(t, n, r, l), (r = !0);
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
    ...
    (i.state = p),
      ...
      u !== r || p !== s || de.current || be
        ? (typeof h == "function" && (jo(t, n, h, r), (s = t.memoizedState)),
          (u = be || Ou(t, n, u, r, p, s, c))
            ? (m ||
...
function Ud(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Zl(Error(g(422)))), wr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (o = Error(g(419))), (r = Zl(o, r, void 0)), wr(e, t, i, r);
  }
  if (((u = (i & e.childLanes) !== 0), fe || u)) {
    ...
    return Bi(), (r = Zl(Error(g(421)))), wr(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function Bd(e, t, n) {
  ...
  switch ((wi(t), t.tag)) {
    ...
    case 4:
      return (
        ln(), $o(e, t), e === null && Wn(t.stateNode.containerInfo), re(t), null
      );
    case 10:
...
function Wd(e, t) {
  ...
  for (Co = { focusedElem: e, selectionRange: n }, Br = !1, E = t; E !== null; )
...
function uc(e) {
  ...
  t !== null && ((e.alternate = null), uc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Ue], delete t[Qn], delete t[No], delete t[_d], delete t[Pd])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Me(e, t, n, r) {
  if (50 < Mn) throw ((Mn = 0), (Qo = null), Error(g(185)));
  bn(e, n, r),
    (!(M & 2) || e !== q) &&
      (e === q && (!(M & 2) && (vl |= n), G === 4 && tt(e, ee)),
      he(e, r),
      n === 1 && M === 0 && !(t.mode & 1) && ((un = K() + 500), dl && yt()));
}
function he(e, t) {
...
function dc(e, t) {
  if (((jr = -1), (Or = 0), M & 6)) throw Error(g(327));
  var n = e.callbackNode;
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = Po(kt.bind(null, e, ce, Ae), t);
            break;
          }
          kt(e, ce, Ae);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Po(kt.bind(null, e, ce, Ae), r);
            break;
          }
          kt(e, ce, Ae);
          break;
...
function Bi() {
  (G === 0 || G === 3 || G === 2) && (G = 4),
    q === null || (!(Rt & 268435455) && !(vl & 268435455)) || tt(q, ee);
}
function rl(e, t) {
  var n = M;
  M |= 2;
  ...
  while (1);
  if ((Ei(), (M = n), (el.current = r), Y !== null)) throw Error(g(261));
...
gc = function (e, t, n) {
  ...
  else (fe = !1), $ && t.flags & 1048576 && ka(t, Yr, t.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (ci(t, n | 1), he(t, K()), !(M & 6) && ((un = K() + 500), yt()));
      }
      break;
    case 13:
      Tt(function () {
...
$s = Ui;
Bs = Tt;
var op = { usingClientEntryPoint: !1, Events: [tr, Bt, fl, Ds, Us, Ui] },
  Sn = {
...
const Lp = L.createContext(null),
  Rp = L.createContext(null),
  Lc = L.createContext(null),
  xl = L.createContext(null),
  Cl = L.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
  Rc = L.createContext(null);
function Ki() {
  return L.useContext(xl) != null;
}
function Tp() {
  return Ki() || me(!1), L.useContext(xl).location;
}
function jp(e, t) {
  return Op(e, t);
}
function Op(e, t, n) {
  Ki() || me(!1);
  let { navigator: r } = L.useContext(Lc),
    { matches: l } = L.useContext(Cl),
    o = l[l.length - 1],
    i = o ? o.params : {};
  o && o.pathname;
...
const Ip = L.createElement(Mp, null);
...
function Dp(e) {
  ...
  return (
    ...
    L.createElement(Cl.Provider, { value: t }, r)
  );
}
function Up(e, t, n) {
  var r;
...
function $p(e) {
  let t = L.useContext(Rp);
  return t || me(!1), t;
}
function Bp(e) {
  let t = L.useContext(Cl);
  return t || me(!1), t;
}
function Ap(e) {
  let t = Bp(),
...
function Vp() {
  var e;
  let t = L.useContext(Rc),
    n = $p(Zo.UseRouteError),
    r = Ap(Zo.UseRouteError);
...
function Wp(e) {
  ...
  return w == null
    ...
    : L.createElement(
        Lc.Provider,
        { value: s },
        L.createElement(xl.Provider, { children: n, value: w }),
      );
}
function Hp(e) {
...
function Kp(e) {
  ...
  return (
    L.useLayoutEffect(() => i.listen(h), [i, h]),
    L.createElement(Wp, {
      basename: t,
      children: n,
      location: u.location,
...
const Yp = () =>
  ...
  Gp = () =>
    C.jsx("div", { children: "Oops! You've Strayed Into the Twilight Zone" }),
  Zp = () => C.jsx("div", { children: "UnchartedTerritory" }),
  Jp = () =>
    C.jsx("div", {
      children:
  ...
  cs = () => C.jsx(C.Fragment, { children: C.jsx(Yp, {}) }),
  bp = () =>
    C.jsxs("div", {
      className: "error-page",
      children: [
        C.jsx("h1", { children: "Server Error" }),
  ...
  eh = () =>
    C.jsxs(C.Fragment, {
      children: [
        C.jsxs("header", {
          children: [
            C.jsx("h1", { children: "Experience Authentic Mexican Flavors" }),
            C.jsx("p", { children: "Get Notified with Our Mobile App!" }),
          ],
        }),
        C.jsx("section", {
          id: "menu",
          children: C.jsx("h2", { children: "Menu" }),
        }),
        C.jsxs("section", {
          id: "app-notification",
          children: [
            C.jsx("h2", { children: "Mobile App Notification" }),
            C.jsx("p", {
              children:
                "Stay updated with our daily specials, promotions, and events by downloading our app.",
            }),
            C.jsx("a", {
              href: "link-to-your-app-on-app-store",
              target: "_blank",
              children: "Download on the App Store",
            }),
            C.jsx("a", {
              href: "link-to-your-app-on-play-store",
              target: "_blank",
        ...
        C.jsx("section", {
          id: "how-it-works",
          children: C.jsx("h2", { children: "How It Works" }),
        }),
        C.jsx("section", {
          id: "customer-reviews",
          children: C.jsx("h2", { children: "Customer Reviews" }),
        }),
        C.jsx("section", {
          id: "location-hours",
          children: C.jsx("h2", { children: "Location and Hours" }),
        }),
        C.jsx("section", {
          id: "contact",
          children: C.jsx("h2", { children: "Contact Us" }),
        }),
        C.jsx("section", {
          id: "social-media",
          children: C.jsx("h2", { children: "Follow Us on Social Media" }),
        }),
        C.jsx("section", {
          id: "newsletter",
          children: C.jsx("h2", { children: "Subscribe to Our Newsletter" }),
        }),
        C.jsx("footer", {}),
      ],
    }),
  ...
  nh = () =>
    C.jsxs(Hp, {
      children: [
        C.jsx(_n, { path: "/", element: C.jsx(th, {}) }),
        C.jsx(_n, { path: "/notfound", element: C.jsx(cs, {}) }),
        C.jsx(_n, { path: "/error", element: C.jsx(bp, {}) }),
        C.jsx(_n, { path: "/*", element: C.jsx(cs, {}) }),
      ],
    });
function rh() {
  return C.jsx(C.Fragment, {
    children: C.jsx(Kp, { children: C.jsx(nh, {}) }),
  });
}
eo.createRoot(document.getElementById("root")).render(
  C.jsx(L.StrictMode, { children: C.jsx(rh, {}) }),
);
