      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (y = S, f = w, a = 0, d = y; d; d = It(d)) a++;
...
function za(e) {
  ...
  function y(f, a, d, v) {
    ...
    for (
      var C = (k = null), _ = a, N = (a = 0), H = null, O = d.next();
      _ !== null && !O.done;
      N++, O = d.next()
    ) {
      _.index > N ? ((H = _), (_ = null)) : (H = _.sibling);
    ...
    if (_ === null) {
      for (; !O.done; N++, O = d.next())
        (O = m(f, O.value, v)),
          O !== null &&
            ((a = o(O, a, N)), C === null ? (k = O) : (C.sibling = O), (C = O));
      return $ && St(f, N), k;
    }
...
function Qa(e, t, n) {
  return Lt & 21
    ? (Me(n, t) || ((n = Xs()), (A.lanes |= n), (Rt |= n), (e.baseState = !0)),
      t)
...
function jd(e, t, n) {
  ...
  if (Ya(e)) Xa(t, l);
    ...
    (n = Ca(e, t, l, r)),
      n !== null && ((l = ue()), Ie(n, e, r, l), Ga(n, t, r));
  }
}
function Ya(e) {
  var t = e.alternate;
...
function Ie(e, t, n, r) {
  if (50 < In) throw ((In = 0), (Qo = null), Error(g(185)));
  bn(e, n, r),
    (!(I & 2) || e !== q) &&
      (e === q && (!(I & 2) && (vl |= n), G === 4 && tt(e, ee)),
      he(e, r),
      n === 1 && I === 0 && !(t.mode & 1) && ((un = K() + 500), dl && yt()));
}
function he(e, t) {
...
function dc(e, t) {
  if (((jr = -1), (Or = 0), I & 6)) throw Error(g(327));
  var n = e.callbackNode;
...
function rl(e, t) {
  ...
  while (1);
  if ((Ei(), (I = n), (el.current = r), Y !== null)) throw Error(g(261));
  ...
  if (rt !== null) {
    ...
    try {
      if (((_e.transition = null), (M = 16 > e ? 16 : e), rt === null))
        ...
        if (((e = rt), (rt = null), (nl = 0), I & 6)) throw Error(g(331));
        var l = I;
...
const Mp = L.createElement(Ip, null);
...
const Yp = () =>
  ...
  cs = () => P.jsx(P.Fragment, { children: P.jsx(Yp, {}) }),
  Xp = () =>
    P.jsxs("div", {
      className: "error-page",
      children: [
        P.jsx("h1", { children: "Server Error" }),
        P.jsx("p", { children: "Sorry, an unexpected error has occurred." }),
      ],
    }),
  Gp = () =>
    P.jsxs(P.Fragment, {
      children: [
        P.jsxs("header", {
          children: [
            P.jsx("h1", { children: "Experience Authentic Mexican Flavors" }),
            P.jsx("p", { children: "Get Notified with Our Mobile App!" }),
          ],
        }),
        P.jsx("section", {
          id: "menu",
          children: P.jsx("h2", { children: "Menu" }),
        }),
        P.jsxs("section", {
          id: "app-notification",
          children: [
            P.jsx("h2", { children: "Mobile App Notification" }),
            P.jsx("p", {
              children:
        ...
        P.jsx("section", {
          id: "how-it-works",
          children: P.jsx("h2", { children: "How It Works" }),
        }),
        P.jsx("section", {
          id: "customer-reviews",
          children: P.jsx("h2", { children: "Customer Reviews" }),
        }),
        P.jsx("section", {
          id: "location-hours",
          children: P.jsx("h2", { children: "Location and Hours" }),
        }),
        P.jsx("section", {
          id: "contact",
          children: P.jsx("h2", { children: "Contact Us" }),
        }),
        P.jsx("section", {
          id: "social-media",
          children: P.jsx("h2", { children: "Follow Us on Social Media" }),
        }),
        P.jsx("section", {
          id: "newsletter",
          children: P.jsx("h2", { children: "Subscribe to Our Newsletter" }),
        }),
        P.jsx("footer", {}),
      ],
    }),
  ...
  Jp = () =>
    P.jsxs(Hp, {
      children: [
        P.jsx(_n, { path: "/", element: P.jsx(Zp, {}) }),
        P.jsx(_n, { path: "/notfound", element: P.jsx(cs, {}) }),
        P.jsx(_n, { path: "/error", element: P.jsx(Xp, {}) }),
        P.jsx(_n, { path: "/*", element: P.jsx(cs, {}) }),
      ],
    });
function qp() {
  return P.jsx(P.Fragment, {
    children: P.jsx(Kp, { children: P.jsx(Jp, {}) }),
  });
}
eo.createRoot(document.getElementById("root")).render(
  P.jsx(L.StrictMode, { children: P.jsx(qp, {}) }),
);
