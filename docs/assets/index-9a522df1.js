...
function Bd(e, t, n) {
  ...
  switch ((wi(t), t.tag)) {
    ...
    case 17:
      return pe(t.type) && Wr(), re(t), null;
    case 19:
      if ((D(B), (o = t.memoizedState), o === null)) return re(t), null;
    ...
    U.jsx(U.Fragment, {
      children: U.jsxs("div", {
        ...
        children: [
          ...
          U.jsx("a", { href: "/", children: "Escape Back to Safety!" }),
        ],
      }),
    }),
  cs = () => U.jsx(U.Fragment, { children: U.jsx(Yp, {}) }),
  Xp = () =>
    U.jsx(Hp, {
      children: U.jsxs(U.Fragment, {
        children: [
          U.jsx(Zo, { path: "/notfound/*", element: U.jsx(cs, {}) }),
          U.jsx(Zo, { path: "/*", element: U.jsx(cs, {}) }),
        ],
      }),
    });
function Gp() {
  return U.jsx(U.Fragment, {
    children: U.jsx(Kp, { children: U.jsx(Xp, {}) }),
  });
}
bl.createRoot(document.getElementById("root")).render(U.jsx(Gp, {}));
